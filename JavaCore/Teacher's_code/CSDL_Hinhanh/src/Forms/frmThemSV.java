...
public class frmThemSV extends javax.swing.JFrame {
    ...
    private void btnChonanhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonanhActionPerformed
        // TODO add your handling code here:
        JFileChooser OpenFile = new JFileChooser();// tạo đối tượng để người dùng chọn file.
        FileNameExtensionFilter fft = 
          new FileNameExtensionFilter("Hình ảnh (JPG, PNG..)", new String[]{"jpg","jpeg","gif","png"} );// tạo đối tượng lọc file.
        OpenFile.addChoosableFileFilter(fft);// khi chọn file thì thêm đối tượn lọc file.
        int re = OpenFile.showOpenDialog(this);// hiển thị hộp thoại open file
        // kết thúc việc chọn file bằng cửa sổ java
