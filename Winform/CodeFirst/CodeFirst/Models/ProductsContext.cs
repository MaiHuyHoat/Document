...
namespace CodeFirst.Models
{
    internal class ProductsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseSqlServer("Data Source=DESKTOP-KU0MU31\\SQLEXPRESS;Initial Catalog=CodeFirst;Integrated Security=True");
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 1, Name = "Cheese" },
